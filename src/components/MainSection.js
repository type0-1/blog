...
const cardData = [
  ...
  },
  {
  ...
  },
    {
      ...
      desc: "Enhanced dataset management, implemented dataset upload, revamped signup/login with Flask API, and enhanced access control.",
      authorImage: samsonImage,
      blogId: 37,
    },
    {
      blogTitle: "User and ACL Management Enhancements",
      author: "Marjia Siddik",
      date: "26th Jan. 2025",
      topic: "🔑 Access Control",
      desc: "Restricted access to authenticated users, fixed ACL endpoint, and added a user management page.",
      authorImage: marjiaImage,
      blogId: 36,
    },
    {
      blogTitle: "Refining Requirements and Project Setup",
      author: "Samson Oloruntola",
      date: "25th Jan. 2025",
      topic: "⚙️ Development Setup",
      desc: "Improved project setup by updating dependencies, clearing cached files, and refining authentication.",
      authorImage: samsonImage,
      blogId: 35,
    },
    {
      ...
      desc: "Added .gitignore and organised files for seamless server, API, and frontend workflows.",
      authorImage: samsonImage,
      blogId: 34,
    },
    {
    ...
    },
    {
      ...
      desc: "Reorganised server files into directories and added template unit tests.",
      authorImage: samsonImage,
      blogId: 26,
    },
    {
  ...
  },
  {
    ...
    desc: "Reorganised Path ORAM into modules and began implementing key features in tree.py.",
    authorImage: samsonImage,
    blogId: 19, 
  },
  {
  ...
  },
  {
    ...
    desc: "Completed and finalised the functional specification draft.",
    authorImage: marjiaImage,
    blogId: 15,
